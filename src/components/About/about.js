      ...
      <div className="about-container-component" id="about">
        ...
        <div>
          <p className="about-me-message">
            ...
            I'm a self-starter that is driven to uncover the "why" in how things
            work.
          </p>
          <br></br>
          <p className="about-me-message">
            ...
            outside the box for solving various real world problems and being
            able to let my creativity run freely. Since then, I have found a
            love for creating elegant apps to which I decided to push myself to
            learn other programming languages and technologies. I'm always
            trying to further advance my capabilities to see where my creativity
            leads me.
          </p>
          <br></br>
          <p className="about-me-message">
            ...
            rather seek comfort in embracing the <i>unknown</i> to be able to
            shed light on new solutions. I am a problem solver that wants to
            utilize my skills to help other people and to be able to make the
