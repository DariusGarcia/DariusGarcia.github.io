      ...
      <section className="card-list">
        ...
        <article className="card">
          <header className="card-header">
            <h1>Instapic</h1>
            <p>
              Instapic is an Android photo sharing app similar to Instagram but
              uses Back4App as its backend.
            </p>
          </header>
        ...
        <article className="card">
          <header className="card-header">
            ...
            <p>
              ...
              timeline and post a new tweet. The app utilizes Twitter REST API.
            </p>
          </header>
          <a href="https://github.com/dariusgarcia/tweeter">Link to Tweeter</a>
        </article>
        <article className="card">
          <header className="card-header">
            <h1>Flixter</h1>
            <p>
              Flixter is an app that allows users to browse movies from the [The
              Movie Database API]
            </p>
          </header>
          <a href="https://github.com/dariusgarcia/flixter">Link to Flixter</a>
        </article>
      </section>
    </div>
  );
